"""Business logic for the dedicated Gammavet route-continuation lambda."""
...
ACTOR_LAMBDA = "gammavet_continuar_ruta"
DEFAULT_FUNCTION_UUID = "00000000-0000-4000-8000-000000000002"


class FunctionBackend:
    """Continue to the exact intended current or next stop for a Gammavet driver."""
    ...
    def __init__(self, orchestration_event: OrchestrationEvent):
        ...
        logger.info(
            "Initialized ContinuarRutaFn for org=%s",
    ...
    def process_request(self) -> str:
        return _start_requested_stop(
            ...
            message_prefix="Siguiente parada de retiro",
            started_label="continuada",
        )

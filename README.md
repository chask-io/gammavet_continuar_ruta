...
Continua la ruta de un conductor Gammavet hacia la parada indicada
...
- The function name matches "ContinuarRutaFn"
...
- AWS CloudWatch Logs: `/aws/lambda/ContinuarRutaFn`
- Chask dashboard: Organization → Functions → ContinuarRutaFn
